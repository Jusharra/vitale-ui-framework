/*
  # Add Contact Information Columns to Care Facilities Table

  1. Changes
    - Add `email` column to store facility contact email
    - Add `phone` column to store facility contact phone number
    - Add `website` column to store facility website URL
    - Add `hours` column to store facility operating hours
    - Add `virtual_tour_url` column to store link to virtual tour
*/
