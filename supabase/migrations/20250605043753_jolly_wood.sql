/*
  # Add Stripe Integration and Facility Media Support
  ...
  2. Schema Updates
    - Add Stripe and membership columns to profiles table
    - Add images and videos columns to care_facilities table
