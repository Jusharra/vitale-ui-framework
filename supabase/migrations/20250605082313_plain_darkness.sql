/*
  # Add services column to care_facilities

  1. New Columns
    - `services` - Array of service IDs offered by the facility
    - `slug` - URL-friendly identifier for the facility
  
  2. Changes
    - Add unique constraint to slug column
    - Create function to generate unique slugs
    - Create trigger to auto-generate slugs for new facilities
