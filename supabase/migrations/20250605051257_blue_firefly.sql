/*
  ...
  1. Changes
    ...
    - Ensures care_facilities table has images and videos columns
  
  2. Security
    - Public read access for viewing facility media
    - Authenticated users can upload files
    - Users can update/delete their own uploads (or admins can manage all)
*/
