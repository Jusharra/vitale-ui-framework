/*
  # Add storage bucket for partner images

  1. New Storage Bucket
    - Create a new storage bucket for partner profile images
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      'Public Read Access for partner_images',
      '(bucket_id = ''partner_images''::text)',
      'partner_images'
    );
  END IF;
END $$;
