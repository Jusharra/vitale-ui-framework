/*
  # Add contact and website fields to care_facilities table

  1. Changes
    - Add email column to care_facilities table
    - Add phone column to care_facilities table
    - Add website column to care_facilities table
    - Add hours column to care_facilities table
    - Add virtual_tour_url column to care_facilities table
  
  This migration adds contact information and website fields to the care_facilities table
  to support the facility detail view and admin management features.
*/
