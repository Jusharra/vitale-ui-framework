...
import { Calendar, MessageSquare, FileText, User, Users, ListCheck, Briefcase, PiggyBank, CreditCard, Palette, Pill, Activity, Bell, Heart, TrendingUp } from 'lucide-react';
