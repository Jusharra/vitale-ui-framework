    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Card className="border-l-4 border-l-primary hover:shadow-md transition-shadow">
        <CardHeader className="pb-2">
          ...
          <CardDescription className="font-medium">Total Members</CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card className="border-l-4 border-l-green-600 hover:shadow-md transition-shadow">
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-4xl font-bold">${(stats.revenue.mtd / 1000).toFixed(1)}k</CardTitle>
          <CardDescription className="font-medium">Revenue MTD</CardDescription>
        </CardHeader>
      </Card>
      
      {/* New Leads Card - Blue Theme */}
      <Card className="border-l-4 border-l-blue-600 hover:shadow-md transition-shadow">
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-4xl font-bold">{stats.newLeadsThisWeek}</CardTitle>
          <CardDescription className="font-medium">New Leads This Week</CardDescription>
        </CardHeader>
      </Card>
      
      {/* Referral Conversions Card - Purple Theme */}
      <Card className="border-l-4 border-l-purple-600 hover:shadow-md transition-shadow">
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-4xl font-bold">{stats.referralConversions}</CardTitle>
          <CardDescription className="font-medium">Referral Conversions</CardDescription>
        </CardHeader>
      </Card>
    </div>
  );
