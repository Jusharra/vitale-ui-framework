    ...
    <MainLayout>
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">State-Specific Resources</h2>
            
            <Tabs defaultValue="california">
              ...
              <TabsContent value="california" className="mt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle>California Department of Aging</CardTitle>
                      <CardDescription>State agency dedicated to serving older Californians</CardDescription>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>California Medicaid (Medi-Cal)</CardTitle>
                      <CardDescription>Healthcare program for low-income individuals</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Medi-Cal is California's Medicaid program serving low-income individuals, including families with children, seniors, persons with disabilities, foster care, pregnant women, and childless adults with incomes below 138% of federal poverty level.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            ...
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                            dhcs.ca.gov/services/medi-cal
                          </a>
                        </div>
                        <div className="flex items-center">
                          <Phone className="h-4 w-4 text-gray-500 mr-2" />
                          <span>1-800-541-5555</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>California Caregiver Resource Centers</CardTitle>
                      <CardDescription>Support for family caregivers</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        California's Caregiver Resource Centers (CRCs) provide support and information for family caregivers of adults with chronic health conditions.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            href="https://www.caregivercalifornia.org/" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>California IHSS Program</CardTitle>
                      <CardDescription>In-Home Supportive Services</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        The IHSS Program helps pay for services provided to eligible seniors and individuals who are blind or disabled so they can remain safely in their own homes.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            href="https://www.cdss.ca.gov/in-home-supportive-services" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                        ...
                        <div className="flex items-center">
                          <Phone className="h-4 w-4 text-gray-500 mr-2" />
                          <span>Contact your county IHSS office</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter>
              ...
              <TabsContent value="texas" className="mt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle>Texas Health and Human Services</CardTitle>
                      <CardDescription>State agency providing health and human services</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Texas Health and Human Services provides a wide range of services for older Texans, including Medicaid, long-term care, and community services.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            href="https://www.hhs.texas.gov/services/aging" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>Texas Medicaid</CardTitle>
                      <CardDescription>Healthcare program for eligible Texans</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Texas Medicaid provides health coverage to eligible low-income adults, children, pregnant women, elderly adults and people with disabilities.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>Area Agencies on Aging (AAA)</CardTitle>
                      <CardDescription>Local resources for seniors in Texas</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Texas has 28 Area Agencies on Aging that help older adults and their caregivers receive the services and supports they need to age with dignity and independence.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            href="https://www.hhs.texas.gov/services/aging/care-older-texans/area-agencies-aging" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                            hhs.texas.gov/services/aging/area-agencies-aging
                          </a>
                        </div>
                        <div className="flex items-center">
                          <Phone className="h-4 w-4 text-gray-500 mr-2" />
                          <span>1-800-252-9240</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>Texas STAR+PLUS Program</CardTitle>
                      <CardDescription>Managed care program for seniors and people with disabilities</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        STAR+PLUS is a Texas Medicaid managed care program for people who have disabilities or are age 65 or older. STAR+PLUS provides health care, acute care, and long-term services and supports.
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Globe className="h-4 w-4 text-gray-500 mr-2" />
                          <a 
                            href="https://www.hhs.texas.gov/services/health/medicaid-chip/programs-services/starplus" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="text-indigo-600 hover:text-indigo-800 hover:underline"
                          >
                            hhs.texas.gov/services/starplus
                          </a>
                        </div>
                        <div className="flex items-center">
                          <Phone className="h-4 w-4 text-gray-500 mr-2" />
                          <span>1-877-782-6440</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter>
